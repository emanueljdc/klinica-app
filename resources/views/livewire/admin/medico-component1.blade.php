            ...
            <div class="card-header bg-light"> 
                ...
                <form method="post" wire:submit.prevent ="store"> 
                    <div class="form-group">
                        <input type="text" wire:model="nomeM" name="nome" id="nome"  class="form-control" placeholder="Nome do médico">
                        @error('nome') <span class="error">{{ $message}}</span> @enderror
                    </div>

                    <button type="button" wire:click="store"  class="btn btn-primary btn-sm">
                        Inserir Médico
                    </button>
                </form> 
            </div>
