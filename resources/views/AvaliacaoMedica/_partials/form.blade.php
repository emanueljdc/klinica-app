@csrf
<input type="text" value="{{ Auth::user()->id ?? old('user_id') }}" name="user_id" class="form-control" placeholder="ID do User">
<input type="text" value="{{ Auth::user()->name  }}" name="name" class="form-control" placeholder="Nome do User">
